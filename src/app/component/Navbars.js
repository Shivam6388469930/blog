...
//   { name: "Article", href: "/user/articles", current: false },
//   { name: "About", href: "/user/about", current: false },
...
const navItems = [
  { name: "Home", href: "/" },
  { name: "Article", href: "/user/articles" },
  { name: "About", href: "/user/about" },
  { name: "Dashboard", href: "/user/dashboard", authRequired: true },
];
...
export default function Navbar() {
  ...
  return (
    <Disclosure as="nav" className="bg-gray-800 dark:bg-gray-900 sticky top-0 z-10 shadow-lg transition">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex space-x-4">
                    {navItems.map((item) => {
                      if (item.authRequired && !userName) return null;
                      return (
                        <a
                          key={item.name}
                          href={item.href}
